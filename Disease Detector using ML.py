...
w2 = Label(root, justify=CENTER, text="A Project by narender choudhary", fg="white", bg="blue")
...
D1Lb = Label(root, text="Diseases caused", fg="white", bg="black")
D1Lb.grid(row=12, column=0, pady=10, sticky=W)

lrLb = Label(root, text="Disease1", fg="white", bg="red")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="Disease2", fg="white", bg="red")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="Disease3", fg="white", bg="red")
...
dst = Button(root, text="Disease1", command=DecisionTree,bg="green",fg="yellow")
dst.grid(row=8, column=3)

rnf = Button(root, text="Disease2", command=randomforest,bg="green",fg="yellow")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="Disease3", command=NaiveBayes,bg="green",fg="yellow")
